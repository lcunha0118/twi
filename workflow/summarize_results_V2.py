...
outputfolder_summary="/home/west/git_repositories/topmodel_fork_NOAA/topmodel/params/data/summary/"
if not os.path.exists(outputfolder_summary): os.mkdir(outputfolder_summary)
    
hydro_fabrics_input_dir="/home/west/git_repositories/topmodel_fork_NOAA/topmodel/params/data/hydrofabrics/20210511/"
Resolution=30
method=1
...
catchments = os.path.join(hydro_fabrics_input_dir, 'catchments_wgs84.geojson')
flowpaths = os.path.join(hydro_fabrics_input_dir, 'flowpaths_wgs84.geojson')
